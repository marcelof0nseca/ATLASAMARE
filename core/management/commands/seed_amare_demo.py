    ...
    def _seed_explore_content(self, patients, now):
        partner_data = [
            (
                ...
                "Apoio emocional para momentos de ansiedade, espera e tomada de decisão.",
            ...
            (
                ...
                "Orientação nutricional complementar para rotina alimentar durante o tratamento.",
            ...
            (
                ...
                "Serviço complementar voltado a relaxamento e bem-estar.",
        ...
        support_community_data = [
            (
                ...
                "Comunidade BabyCenter Brasil para trocar experiências, dúvidas e acolhimento com outras tentantes.",
                "BabyCenter Brasil",
            ...
            (
                ...
                "Tentantes que buscam relatos reais e identificação",
                "Busca pública no Instagram com relatos e vivências compartilhadas por tentantes usando a hashtag #vidadetentante.",
    ...
    def _seed_journey_videos(self):
        videos = [
            (
                ...
                "Orientações simples para chegar mais tranquila ao exame e saber o que esperar.",
                1,
            ...
            (
                ...
                "Passo a passo visual para organizar a rotina antes da aplicação.",
                5,
                "https://www.youtube.com/embed/dQw4w9WgXcQ",
                "6 min",
                True,
            ...
            (
                "Coleta de exames",
                "Explicação de apoio para entender a coleta e reduzir dúvidas comuns.",
                7,
                "https://www.youtube.com/embed/dQw4w9WgXcQ",
                "5 min",
                True,
